...
def prediction(request):
    ...
    books = pd.read_csv('C:\\Users\\avihw\\Desktop\\BX-Books.csv', sep=';', error_bad_lines=False, encoding="latin-1")
    books.columns = ['ISBN', 'bookTitle', 'bookAuthor', 'yearOfPublication', 'publisher', 'imageUrlS', 'imageUrlM',
                     'imageUrlL']
    users = pd.read_csv('C:\\Users\\avihw\\Desktop\\BX-Users.csv', sep=';', error_bad_lines=False, encoding="latin-1")
    users.columns = ['userID', 'Location', 'Age']
    ratings = pd.read_csv('C:\\Users\\avihw\\Desktop\\BX-Book-Ratings.csv', sep=';', error_bad_lines=False,
                          encoding="latin-1")
